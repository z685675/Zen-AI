export enum IpcChannel {
  ...
  File_Read = 'file:read',
  File_ReadStructured = 'file:readStructured',
  File_ReadEmbeddedImages = 'file:readEmbeddedImages',
  ...
  File_DeleteAgentAttachmentDir = 'file:deleteAgentAttachmentDir',
  File_Move = 'file:move',
  ...
  File_Copy = 'file:copy',
  File_CopyToAgentAttachment = 'file:copyToAgentAttachment',
