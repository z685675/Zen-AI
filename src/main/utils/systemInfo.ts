...
export function generateUserAgent(): string {
  ...
  const uaProductName = APP_NAME.replace(/\s+/g, '')

  return `Mozilla/5.0 (${systemInfo.osString}; ${systemInfo.archString}) AppleWebKit/537.36 (KHTML, like Gecko) ${uaProductName}/${systemInfo.appVersion} Chrome/124.0.0.0 Safari/537.36`
}
