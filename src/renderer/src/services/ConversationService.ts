...
export class ConversationService {
   ...
   */
  static filterMessagesPipeline(messages: Message[], _legacyContextCount?: number): Message[] {
    void _legacyContextCount
  ...
  static async prepareMessagesForModel(
    ...
    const uiMessagesFromPipeline = ConversationService.filterMessagesPipeline(messages)
