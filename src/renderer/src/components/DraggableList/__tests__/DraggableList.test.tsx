...
describe('DraggableList', () => {
  ...
  describe('drag and drop', () => {
    ...
    it('should call onDragStart and onDragEnd', () => {
      ...
      // 先手动调�?onDragStart
      onDragStart()
      // 再模拟拖拽结�?      window.triggerOnDragEnd({ source: { index: 0 }, destination: { index: 1 } }, {})
    ...
    it('should not call onUpdate if dropped at same position', () => {
      ...
      // 模拟拖拽到自�?      window.triggerOnDragEnd({ source: { index: 1 }, destination: { index: 1 } }, {})
  ...
  describe('edge cases', () => {
    ...
    it('should handle items without id', () => {
      ...
      // 拖拽�?项到�?�?      window.triggerOnDragEnd({ source: { index: 0 }, destination: { index: 2 } }, {})
      expect(onUpdate).toHaveBeenCalledTimes(1)
  ...
  describe('interaction', () => {
    it('should show placeholder during drag', () => {
      ...
      // placeholder 应该在初始渲染时就存�?      const placeholder = screen.getByTestId('placeholder')
    ...
    it('should reorder correctly when dragged to first/last', () => {
      ...
      // 拖拽�?项到�?�?      window.triggerOnDragEnd({ source: { index: 2 }, destination: { index: 0 } }, {})
