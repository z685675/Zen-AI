...
describe('Collection Utils', () => {
  ...
  describe('Type Safety', () => {
    ...
    it('should enforce type constraints at compile time', () => {
      ...
      //
      // 鉂?Error: Type '{ id: number; name: string; }' does not satisfy the constraint 'string | number | boolean | null | undefined'
      // getIntersection(obj1, obj2)
      //
      // 鉂?Error: Expected 3 arguments, but got 2. Object types require a comparator.
      // getDifference(obj1, obj2)
      //
      // 鉂?Error: Expected 3 arguments, but got 2. Object types require a comparator.
      // getUnion(obj1, obj2)

      // 鉁?Correct usage with key selector
