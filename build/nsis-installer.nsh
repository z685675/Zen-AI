...
!macro customInit
  ...
  ${If} $0 != "1"
    MessageBox MB_ICONEXCLAMATION "\
      ...
      https://github.com/z685675/Zen-AI/releases"
    ExecShell "open" "https://github.com/z685675/Zen-AI/releases"
    Abort
  ${EndIf}
...
!macro customInstall
  WriteRegStr HKCU "Software\Classes\zenai" "" "URL:${PRODUCT_NAME} Protocol"
  WriteRegStr HKCU "Software\Classes\zenai" "URL Protocol" ""
  WriteRegStr HKCU "Software\Classes\zenai\DefaultIcon" "" "$INSTDIR\${PRODUCT_NAME}.exe,0"
  WriteRegStr HKCU "Software\Classes\zenai\shell\open\command" "" '"$INSTDIR\${PRODUCT_NAME}.exe" "%1"'
!macroend
